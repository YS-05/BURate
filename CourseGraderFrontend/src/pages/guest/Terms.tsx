                ...
                <div className="card-body p-5">
                  ...
                  <div className="terms-content">
                    <section className="mb-4">
                      ...
                      <p>
                        By accessing or using CourseGrader, you agree to be
                    ...
                    <section className="mb-4">
                      ...
                      <div className="alert alert-warning">
                        ...
                        <ul className="mb-0 mt-2">
                          <li>
                            Contains false, misleading, or defamatory
                            information
                          </li>
                          <li>
                    ...
                    <section className="mb-4">
                      ...
                      <ul>
                        ...
                        <li>
                          Use the Service for any commercial purposes without
                          our permission
                        </li>
                      </ul>
                      ...
                      <div className="alert alert-info">
                        <strong>
                          CourseGrader is designed to help students make
                          informed course decisions, not to:
                        </strong>
                        <ul className="mb-0 mt-2">
                    ...
                    <section className="mb-4">
                      ...
                      <ul>
                        ...
                        <li>
                          Cooperate with educational institutions regarding
                          policy violations
                        </li>
                      </ul>
                    ...
                    <section className="mb-4">
                      ...
                      <ul>
                        ...
                        <li>
                          We do not verify the accuracy of user-submitted
                          content
                        </li>
                        <li>
                      ...
                      <ul>
                        ...
                        <li>
                          We are not responsible for academic decisions made
                    ...
                    <section className="mb-4">
                      ...
                      <p>
                        ...
                        to do the same. If you believe your intellectual
                        property has been infringed, please contact us at
                    ...
                    <section className="mb-4">
                      ...
                      <p>
                        ...
                        Service will cease immediately, and all your data will
                        be deleted as described in our Privacy Policy.
                      </p>
                    ...
                    <section className="mb-4">
                      ...
                      <p>
                        ...
                        with the laws of Massachusetts, without regard to
                    ...
                    <section className="mb-4">
                      ...
                      <div className="alert alert-primary">
                        ...
                        officially affiliated with Boston University or any
                        other educational institution. This platform was
                        developed as an individual project to help students
                        share course experiences and make informed academic
                        decisions.
                        <br />
                        <br />
