          ...
          <div className="col-12">
            <div className="card border-0 shadow-sm">
              <div className="card-body p-5">
                <h1 className="text-danger mb-4 text-center">Privacy Policy</h1>
                ...
                <div className="privacy-content">
                  <section className="mb-4">
                    ...
                    <p>
                      ...
                      safeguard your information when you use our course review
                  ...
                  <section className="mb-4">
                    ...
                    <ul>
                      ...
                      <li>
                        Personalizing your course recommendations (coming soon)
                      </li>
                  ...
                  <section className="mb-4">
                    ...
                    <ul>
                      ...
                      <li>
                        Aggregate course statistics (average ratings, number of
                        reviews) are public
                      </li>
                      <li>
                    ...
                    <ul>
                      ...
                      <li>
                        <strong>Safety Concerns:</strong> To protect the rights,
                        property, or safety of CourseGrader, our users, or
                        others
                      </li>
                      <li>
                        <strong>Business Transfers:</strong> In connection with
                        a merger, acquisition, or sale of assets (users will be
                        notified)
                      </li>
                      <li>
                  ...
                  <section className="mb-4">
                    ...
                    <ul>
                      ...
                      <li>
                        <strong>Anonymous Display:</strong> Your reviews always
                        appear anonymously to other users
                      </li>
                    </ul>
                  ...
                  <section className="mb-4">
                    ...
                    <p>
                      ...
                      integrate with external services. This Privacy Policy does
                      not apply to third-party services, and we are not
